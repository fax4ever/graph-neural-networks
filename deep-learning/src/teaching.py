...
def separate_training(model_support_1: ModelSupport, model_support_2: ModelSupport, train_dataset, val_dataset,
                      batch_size, num_epochs, device, checkpoint_intervals):
